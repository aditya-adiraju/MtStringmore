...
namespace Yarn
{
    ...
    public static class UnscaledEffects
    {
        ...
        ///     course of <see cref="fadeTime" /> seconds, and then invokes
        ///     <paramref
        ///         name="onComplete" />
        ///     .
        /// </summary>
        /// <param name="from">
        ///     The opacity value to start fading from, ranging
        ///     from 0 to 1.
        /// </param>
        /// <param name="to">
        ///     The opacity value to end fading at, ranging from 0
        ///     to 1.
        /// </param>
        /// <param name="stopToken">
        ///     A <see cref="CoroutineInterruptToken" /> that
        ///     can be used to interrupt the coroutine.
        /// </param>
        ...
        ///     <see
        ///         cref="TextMeshProUGUI" />
        ///     object over time.
        /// </summary>
        /// <remarks>
        ///     <para>
        ///         This method works by adjusting the value of the <paramref name="text" /> parameter's
        ///         <see cref="TextMeshProUGUI.maxVisibleCharacters" /> property. This means that word wrapping will not change
        ///         half-way through the presentation of a word.
        ///     </para>
        ///     <para style="note">
        ///         Depending on the value of <paramref name="lettersPerSecond" />,
        ///         <paramref name="onCharacterTyped" /> may be called multiple times per frame.
        ///     </para>
        ///     <para>
        ///         Due to an internal implementation detail of TextMeshProUGUI, this method will always take at least one frame
        ///         to execute, regardless of the length of the <paramref name="text" /> parameter's text.
        ///     </para>
        /// </remarks>
        /// <param name="text">
        ///     A TextMeshProUGUI object to reveal the text
        ///     of.
        /// </param>
        /// <param name="lettersPerSecond">
        ///     The number of letters that should be
        ///     revealed per second.
        /// </param>
        ...
        ///     can be used to interrupt the coroutine.
        /// </param>
        public static IEnumerator Typewriter(TextMeshProUGUI text, float lettersPerSecond, Action onCharacterTyped,
            CoroutineInterruptToken stopToken = null)
        {
        ...
        /// <param name="pausePositions">
        ///     A stack of character position and pause duration tuples used to pause the effect.
        ///     Generally created by <see cref="LineView.GetPauseDurationsInsideLine" />
        /// </param>
        /// <param name="stopToken">A <see cref="CoroutineInterruptToken" /> that can be used to interrupt the coroutine.</param>
        public static IEnumerator PausableTypewriter(TextMeshProUGUI text, float lettersPerSecond,
            Action onCharacterTyped, Action onPauseStarted, Action onPauseEnded,
            Stack<(int position, float duration)> pausePositions, CoroutineInterruptToken stopToken = null)
        {
            stopToken?.Start();
        ...
        ///         <see
        ///             cref="MonoBehaviour.StopCoroutine" />
        ///         or
        ///         <see
        ///             cref="MonoBehaviour.StopAllCoroutines" />
        ...
        ///         parameter to your coroutine. In the coroutine, call
        ///         <see
        ///             cref="Start" />
        ///         to mark that the coroutine is running. During the
        ///         coroutine's execution, periodically check the
        ///         <see
        ///             cref="WasInterrupted" />
        ///         property to determine if the coroutine
            ...
            public void Interrupt()
            {
                if (CanInterrupt == false)
                    throw new InvalidOperationException(
                        $"Cannot stop {nameof(CoroutineInterruptToken)}; state is {state} (and not {nameof(State.Running)}");
