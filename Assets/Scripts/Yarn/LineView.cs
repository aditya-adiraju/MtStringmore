...
namespace Yarn
{
    ...
    public class LineView : DialogueViewBase
    {
        ...
        /// <remarks>
        ///     <para>
        ///         If this value is <see langword="true" />, the
        ///         <see
        ///             cref="canvasGroup" />
        ///         object's alpha property will animate from 0 to
        ///         1 over the course of <see cref="fadeInTime" /> seconds when lines
        ///         appear, and animate from 1 to zero over the course of
        ///         <see
        ///             cref="fadeOutTime" />
        ///         seconds when lines disappear.
        ///     </para>
        ///     <para>
        ///         If this value is <see langword="false" />, the
        ///         <see
        ///             cref="canvasGroup" />
        ///         object will appear instantaneously.
        ///     </para>
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        ///     This value is only used when <see cref="useFadeEffect" /> is
        ///     <see langword="true" />.
        /// </remarks>
        /// <seealso cref="useFadeEffect" />
        ...
        ///     dialogue lines.
        /// </summary>
        [SerializeField] internal TextMeshProUGUI lineText;
        ...
        ///         <see
        ///             cref="characterNameText" />
        ///         is <see langword="null" />.
        ///     </para>
        ///     <para>
        ///         If this value is <see langword="true" />, any character names
        ///         present in a line will be shown in the <see cref="lineText" />
        ///         object.
        ///     </para>
        ///     <para>
        ///         If this value is <see langword="false" />, character names will
        ///         not be shown in the <see cref="lineText" /> object.
        ///     </para>
        /// </remarks>
        [SerializeField] [FormerlySerializedAs("showCharacterName")]
        ...
        /// </remarks>
        [SerializeField] internal TextMeshProUGUI characterNameText;
        ...
        /// </remarks>
        [SerializeField] internal GameObject characterNameContainer;
        ...
        ///         object's
        ///         <see
        ///             cref="TMP_Text.maxVisibleCharacters" />
        ///         property will animate from 0
        ///         to the length of the text, at a rate of
        ///         <see
        ///             cref="typewriterEffectSpeed" />
        ///         letters per second when the line
        ...
        ///         <see
        ///             cref="lineText" />
        ///         will all be revealed at the same time.
        ///     </para>
        ///     <para style="note">
        ///         If <see cref="useFadeEffect" /> is
        ///         <see
        ///             langword="true" />
        ///         , the typewriter effect will run after the fade-in
        ///         is complete.
        ///     </para>
        /// </remarks>
        ...
        [SerializeField] internal bool useTypewriterEffect;
        ...
        [SerializeField] internal UnityEvent onCharacterTyped;
        ...
        /// </remarks>
        /// <seealso cref="useTypewriterEffect" />
        [SerializeField] internal UnityEvent onPauseStarted;

        /// <summary>
        ///     A Unity Event that is called when a pause inside of the typewriter effect finishes and the typewriter has started
        ///     once again.
        /// </summary>
        /// <remarks>
        ///     This event is only invoked when <see cref="useTypewriterEffect" /> is <see langword="true" />.
        /// </remarks>
        /// <seealso cref="useTypewriterEffect" />
        [SerializeField] internal UnityEvent onPauseEnded;
        ...
        ///         finished presenting its lines. Instead, it will wait until the
        ///         <see
        ///             cref="UserRequestedViewAdvancement" />
        ///         method is called.
        ///     </para>
        ///     <para style="note">
        ///         <para>
        ///             The <see cref="DialogueRunner" /> will not
        ...
        ///             report that it's finished until it receives input, the
        ///             <see
        ///                 cref="DialogueRunner" />
        ///             will end up pausing.
        ///         </para>
        ...
        ///     </para>
        /// </remarks>
        [SerializeField] internal bool autoAdvance;
        ...
        private IEnumerator DismissLineInternal(Action onDismissalComplete)
        {
            ...
            if (onDismissalComplete != null) onDismissalComplete();
        }
            ...
            foreach (var attribute in line.Attributes)
            {
                ...
                if (palette.ColorForMarker(attribute.Name, out markerColour))
                {
                    ...
                    lineOfText = lineOfText.Insert(attribute.Position,
                        $"<color=#{ColorUtility.ToHtmlStringRGB(markerColour)}>");
                }
